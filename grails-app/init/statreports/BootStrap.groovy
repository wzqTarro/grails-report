...
//        def report4 = new Report(code: "YYYCD", name: "用药依从性统计", grpCode: group2.code, runway: 1);
//
//        report1.save();
...
//
//        ReportDatasource datasource = new ReportDatasource(code: "04", name: "数据中心", config: '{"kind":4}').save()
...
//        new ReportTables(dataSource: datasource, name: "virtualTable", rpt: report5, sqlText: "SELECT td.contents ->'a_num' as a_num,td.contents -> 's_num' as s_num,td.contents -> '分类' as 分类 FROM (SELECT contents FROM test_daily) WHERE td.contents ->'分类' = [orgID]")
