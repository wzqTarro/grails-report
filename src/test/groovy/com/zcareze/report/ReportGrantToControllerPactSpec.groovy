...
class ReportGrantToControllerPactSpec extends Specification implements ControllerUnitTest<ReportGrantToController> {
    ...
    def setup() {
        ReportGroups.withNewSession {
            ...
            // 大屏
            def screenReport1 = new Report(code: "01", name: "众康云测试大屏", grpCode: group3.code, runway: 1, comment: "测试说明", cloudId: "1");
            def screenReport2 = new Report(code: "02", name: "众康云正式大屏", grpCode: group3.code, runway: 1, comment: "正式说明", cloudId: "2");
            def screenReport3 = new Report(code: "03", name: "众康云大屏", grpCode: group3.code, runway: 1, comment: "说明", cloudId: "1");
            screenReport1.save()
            screenReport2.save()
            screenReport3.save()
